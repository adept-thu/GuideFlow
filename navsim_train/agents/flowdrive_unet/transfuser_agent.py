...
#from navsim.agents.flowdrive.transfuser_model_v3 import V3TransfuserModel as TransfuserModel
#from navsim.agents.flowdrive.transfuser_model_v7 import V7TransfuserModel as TransfuserModel
#from navsim.agents.flowdrive.transfuser_model_v4 import V4TransfuserModel as TransfuserModel
#from navsim.agents.flowdrive.transfuser_model_v5 import V5TransfuserModel as TransfuserModel
#from navsim.agents.flowdrive.transfuser_model_v6 import V6TransfuserModel as TransfuserModel
#from navsim.agents.flowdrive.transfuser_model_v7 import V7TransfuserModel as TransfuserModel
#from navsim.agents.flowdrive.transfuser_model_v8 import V8TransfuserModel as TransfuserModel
from navsim.agents.flowdrive.transfuser_model_v10 import V10TransfuserModel as TransfuserModel
from navsim.agents.flowdrive.transfuser_callback import TransfuserCallback 
from navsim.agents.flowdrive.transfuser_loss import transfuser_loss
from navsim.agents.flowdrive.transfuser_features import TransfuserFeatureBuilder, TransfuserTargetBuilder
from navsim.common.dataclasses import SensorConfig
from navsim.planning.training.abstract_feature_target_builder import AbstractFeatureBuilder, AbstractTargetBuilder
from navsim.agents.flowdrive.modules.scheduler import WarmupCosLR
...
class TransfuserAgent(AbstractAgent):
    ...
    def init_from_pretrained(self):
        ...
        if self._checkpoint_path:
            ...
            state_dict = {k.replace('agent._', '_'): v for k, v in state_dict.items()}
    ...
    def forward(self, features: Dict[str, torch.Tensor], targets: Dict[str, torch.Tensor]=None, token=None) -> Dict[str, torch.Tensor]:
        """Inherited, see superclass."""
        #import pdb;pdb.set_trace()
        """
        ...
        targets_dict = {}
        targets_dict['trajectory'] = targets
        targets = targets_dict
        """
        return self._transfuser_model.forward_test(features, targets=targets, tokens = token)

    def compute_trajectory(self, agent_input: AgentInput, gt_traj) -> Trajectory:
        """
        ...
        # forward pass
        with torch.no_grad():
            predictions = self.forward(features,gt_traj)
