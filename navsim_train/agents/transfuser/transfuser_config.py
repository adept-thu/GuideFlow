...
class TransfuserConfig:
    ...
    bkb_path: str = "/nas/users/perception-users/liulin/workspace/DiffusionDrive/pytorch_model.bin"
    plan_anchor_path: str = "/nas/users/perception-users/liulin/workspace/DiffusionDrive/assets/fps_navsim_traj_768_3.npy"
