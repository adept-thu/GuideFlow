...
from navsim.common.dataclasses import Scene, AgentInput, SensorConfig, Trajectory
...
def plot_bev_without_agent(scene: Scene, traj: Trajectory) -> Tuple[plt.Figure, plt.Axes]:
    """
    Plots agent and human trajectory in birds-eye-view visualization
    :param scene: navsim scene dataclass
    :param agent: navsim agent
