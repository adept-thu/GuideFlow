...
from navsim.common.dataclasses_new import AgentInput, Scene, SceneFilter, SensorConfig
...
def filter_synthetic_scenes(
    ...
    #Ssynthetic_scenes_paths = []
    synthetic_scenes_paths = synthetic_scenes_paths[401:866] # [0`100`] [101-200] [201-4] [401-60] [601-866]
    #synthetic_scenes_paths.append(ss_synthetic_scenes_paths[100])
    #synthetic_sScenes_paths.append(ss_synthetic_scenes_paths[200])
    #synthetic_scenesS_paths.append(ss_synthetic_scenes_paths[400])
    #synthetic_scenes_paths.append(ss_synthetic_scenes_paths[600])
    token_list = []
    ...
    for scene_path in tqdm(synthetic_scenes_paths, desc="Loading synthetic scenes"):
        ...
        token_list.append(synthetic_scene_pre.scene_metadata.initial_token)
        token_list.append(synthetic_scene_now.scene_metadata.initial_token)
    #import pdb;pdb.set_trace()
...
class SceneLoader:
    ...
    def get_scene_from_token(self, token: str) -> Scene:
        ...
        if token in self.synthetic_scenes_tokens:
            '''
            ...
            '''
            return self.synthetic_scenes[token]
        else:
            #'''
            ...
            #'''
            #return self.scene_frames_dicts[token]
