...
def main(cfg: DictConfig) -> None:
    ...
    dump_path = '/nas/users/perception-users/yuguanyi/playground_2506/code/GTRS_ygy/exp/test_gtrs_dense_navhard_two_stage/navhard_two_stage.pkl' #'/nas/users/perception-users/yuguanyi/playground_2506/code/GTRS/exp/test_flow_navhard_two_stage_1/navhard_two_stage.pkl'
