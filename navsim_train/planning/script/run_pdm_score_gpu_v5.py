...
from navsim.common.dataloader_private import MetricCacheLoader, SceneFilter, SceneLoader
...
#    agent.initialize()
    ...
    scene_loader_inference = SceneLoader(
        synthetic_sensor_path=Path(cfg.synthetic_sensor_path), # 'dataset/private_test_hard_two_stage/sensor_blobs'
        original_sensor_path=Path(cfg.original_sensor_path), # 'dataset/sensor_blobs/private_test_hard'
        data_path=Path(cfg.navsim_log_path), # dataset/navsim_logs/private_test_hard
        synthetic_scenes_path=Path(cfg.synthetic_scenes_path), # dataset/private_test_hard_two_stage/openscene_meta_datas
        scene_filter=scene_filter,
        sensor_config=agent.get_sensor_config(),
    )
    #data_path, # dataset/navsim_logs/private_test_hard
    #original_sensor_path: dataset/sensor_blobs/private_test_hard
    #scene_filter: SceneFilter,
    #synthetic_sensor_path: dataset/private_test_hard_two_stage/sensor_blobs
    #synthetic_scenes_path: dataset/private_test_hard_two_stage/openscene_meta_datas
    #sensor_config: SensorConfig(cam_f0=False, cam_l0=False, cam_l1=False, cam_l2=False, cam_r0=False, cam_r1=False, cam_r2=False, cam_b0=False, lidar_pc=False)
    #import pdb;pdb.set_trace()
    dataset = Dataset(
