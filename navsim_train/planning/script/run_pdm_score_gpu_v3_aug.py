...
def main(cfg: DictConfig) -> None:
    ...
    metric_cache_loader = None #MetricCacheLoader(Path(cfg.metric_cache_path))
    '''
    ...
    import pdb;pdb.set_trace()
    '''
    pkl_path_10 = '/nas/users/perception-users/yuguanyi/playground_2506/code/GTRS/exp/test_gtrs_aug/epoch_navhard_two_stage.pkl'#'./assets/flow_gen/result.pkl'#"./assets/dense_result/private_test_hard_two_stage_1.pkl"
    with open(pkl_path_10, 'rb') as f:
