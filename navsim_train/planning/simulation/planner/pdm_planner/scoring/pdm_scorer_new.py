...
class PDMScorer:
    ...
    def score_proposals(
        ...
        # initialize & lazy load class values observation,
        self._reset(
            states,
            centerline,
            route_lane_ids,
    ...
    def _aggregate_pdm_scores(self) -> npt.NDArray[np.float64]:
        ...
        #print(multiplicate_metric_scores) #[0. 0.]
        #print(self._progress_raw)   # [25.83534229 19.90443397]
        #print(self._config.progress_distance_threshold) # 5.0
    ...
    def _reset(
        self,
        states: npt.NDArray[np.float64], #observation: PDMObservation,
        centerline: PDMPath,
        route_lane_ids: List[str],
        drivable_area_map: PDMDrivableMap,
        ...
        self._observation = None #observation
